<template>
  <div :class="['read-content', skinColor, { night: nightMode }]">
    ...
    <div class="read-content-content">
      <h4 :class="[skinColor, { night: nightMode }]">{{ curBook.lastChapter }}</h4>
      <div
        class="content-list"
      ...
      >
        ...
        <p
          v-for="(content,index) in rc.contentList"
          :key="index"
    ...
    <div :class="['read-content-set', { 'read-opt': isShowSet }]">
      <ul class="read-set-bg-list">
        <li
          v-for="skin in skinBgList"
          class="read-set-bg-item"
          @click="changeBkColor(skin)"
          :key="skin"
        >
      ...
      <div class="read-set-switch">
        <div class="read-set-switch-item">
          <span :class="{ nochange: fontSize <= 10 }" @click="changeFontSize(false)">
            <svg class="icon" aria-hidden="true">
              <use xlink:href="#icon-font-reduce" />
            </svg>
          </span>
        </div>
        <div class="read-set-switch-item">
