<template>
  <div class="book-info-section" v-if="book !== null">
    ...
    <div class="book-menu">
      <router-link :to="{ name: '阅读', params: { id: book._id }, query: { menu: true } }">
...
export default {
  ...
  created() {
    api.getBook(this.curBook.id).then(data => {
      ...
      // this.$store.commit('SetBookInfo',data)
